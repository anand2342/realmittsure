...
class ERPAddSchool extends Component
{
    ...
    public function mount($roles, $schoolList, $schools, $users, $salesman, $distributors, $boards, $mediums, $classes, $subjects, $cities = [],  $states, $userData = null, $school_classes = null)
    {
        $this->roles      = $roles;
        $this->users      = $users;
