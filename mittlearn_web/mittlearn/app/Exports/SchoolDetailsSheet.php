...
class SchoolDetailsSheet implements FromCollection, WithHeadings, WithStyles, WithTitle
{
    ...
    {
        return [
            'S.No', 'Role', 'Unique ID', 'Full Name', 'School Role', 'School Type', 'Username', 'Email',
            'Mobile No.', 'Password', 'Status', 'Academic Session', 'Batch Name', 'Address 1', 'Address 2',
            'State', 'District', 'Pin Code', 'Assign To', 'Website', 'Decision Maker', 'Decision Maker Mobile No.',
            'Decision Maker Role', 'Board', 'Medium', 'Strenght', 'Grade', 'School Affiliation Number/PAN Number',
            'School Registration Number', 'Incorporation Date', 'Assign Distributor', 'GST No.', 'Classes',
            'Bank Name', 'Bank Account Holder Name', 'Branch Name', 'Bank Account Number', 'IFSC Code', 'Created At',
        ];
    }
