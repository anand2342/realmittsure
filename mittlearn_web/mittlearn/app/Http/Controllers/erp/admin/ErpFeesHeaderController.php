...
class ErpFeesHeaderController extends Controller
{
    public $data = [];
    ...
    public function createFeesHeader()
    {
        $this->data['data'] = FeesHeader::paginate(config('constants.PAGINATION.default'));
        return view('erp.admin.feesManagement.feesHeader.add', $this->data);
    }
