...
function sendSms($mobile, $otp, $name, $templateKey = null, $message = null, $templateId = null)
{
    $settings = getSettings();
    if (
    ...
    if (! $otp && $name !== null) {
        ...
        $campaignName = 'Mittlearn Login OTP'; // Approved Campaign Name
    } else if ($otp) {
        // OTP template
        ...
        $campaignName = 'Mittlearn Welcome/Login'; // Approved Campaign Name
    } else if ($templateKey == 'School Missing Detail') {
        // crm_to_rm template
        $smsTxt       = $message;
        $templateId   = '1707177547256111379'; // Approved OTP Template ID
        $campaignName = $templateKey;          // Approved Campaign Name
    } else if ($templateKey == 'School Missing Detail') {
        // crm_to_rm template
        $smsTxt       = $message;
        $templateId   = '1707177547256111379'; // Approved OTP Template ID
        ...
        // crm_to_rm template
        $smsTxt       = $message;
        $templateId   = $templateId; // Approved OTP Template ID 
        $campaignName = $templateKey;          // Approved Campaign Name
    } else {
