                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-end mt-3">
                                @isPermission('board.create')
                                    <a href="{{ route('board.create') }}" class="btn btn-success">
                                        Add New
                                    </a>
                                @endisPermission
                            </div>
                                            ...
                                            <td>
                                                @isPermission('board.edit')
                                                    <a class="btn btn-sm btn-warning"
                                                        href="{{ route('board.edit', $item->id) }}"><i
                                                            class="fa fa-pencil"></i></a>
                                                @endisPermission
                                                @isPermission('board.delete')
                                                    <a class="btn btn-danger btn-sm me-2" href="javascript:void(0);"
                                                        onclick="confirmDetailsDelete('{{ route('board.delete', $item->id) }}','Board')">
