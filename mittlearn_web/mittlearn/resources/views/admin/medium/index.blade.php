            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card-title">All Mediums</div>
                            </div>
                            <div class="col-sm-6 text-end mt-3">
                                @isPermission('medium.create')
                                    <a href="{{ route('medium.create') }}" class="btn btn-success">
                                        Add New
                                    </a>
                                @endisPermission
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @isPermission('medium.edit')
                                                    <a class="btn btn-sm btn-warning"
                                                        href="{{ route('medium.edit', $item->id) }}"><i
                                                            class="fa fa-pencil"></i></a>
                                                @endisPermission
                                                @isPermission('medium.delete')
                                                    <a class="btn btn-danger btn-sm me-2" href="javascript:void(0);"
                                                        onclick="confirmDetailsDelete('{{ route('medium.delete', $item->id) }}','Medium')">
