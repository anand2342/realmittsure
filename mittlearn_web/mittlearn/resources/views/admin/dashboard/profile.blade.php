                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <p class="small fst-italic">{{ $user->additionalDetails->about ?? '' }}</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8">{{ $user->additionalDetails->customer_type ?? '' }}
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Job</div>
                                        <div class="col-lg-9 col-md-8">{{ $user->additionalDetails->designation ?? '' }}
                                        </div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Country</div>
                                        <div class="col-lg-9 col-md-8">{{ $user->additionalDetails->country ?? '' }}</div>
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-3 col-md-4 label">Address</div>
                                        <div class="col-lg-9 col-md-8">{{ $user->additionalDetails->address ?? '' }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <form action="{{ route('admin.profile.update') }}" method="POST"
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <textarea name="about" class="form-control" id="about" style="height: 100px">{{ $user->additionalDetails->about ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="company" type="text" class="form-control" id="company"
                                                    value="{{ $user->additionalDetails->customer_type ?? '' }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="job" type="text" class="form-control" id="Job"
                                                    value="{{ $user->additionalDetails->designation ?? '' }}">
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade pt-3" id="profile-change-password">
                                    ...
                                    <form action="{{ route('admin.change-password.save') }}" method="POST">
                                        @csrf
                                        <!-- Current Password -->
                                        <div class="row mb-3">
