            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card-title">All Languages</div>
                            </div>
                            <div class="col-sm-6 text-end mt-3">
                                @isPermission('language.create')
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @isPermission('language.edit')
                                                    <a class="btn btn-sm btn-warning"
                                                        href="{{ route('language.edit', $item->id) }}"><i
                                                            class="fa fa-pencil"></i></a>
                                                @endisPermission
                                                @isPermission('language.delete')
                                                    <a class="btn btn-danger btn-sm me-2" href="javascript:void(0);"
                                                        onclick="confirmDetailsDelete('{{ route('language.delete', $item->id) }}','Language')">
