        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title pb-0">Language Info</h5>
                            <hr class="form-divider">

                            @if ($flag == 1)
                                {{ Form::model($data, ['url' => route('language.save'), 'id' => 'edit-plan-form', 'class' => 'row g-3']) }}
                                {{ Form::hidden('id', null) }}
                            @else
                                {{ Form::open(['url' => route('language.save'), 'id' => 'add-plan-form', 'class' => 'row g-3']) }}
                            @endif


                                <div class="col-md-6 col-sm-6 col-xs-12">
                                {!! Form::label('name', 'Language Name', ['class' => 'form-label required']) !!}
