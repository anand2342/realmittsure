        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Academic Activities</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body p-3">
                            <form method="GET" action="{{ route('course.academic-activities.index') }}">
                                <div class="row">
                                    <div class="col-md-3">
                                        <input type="text" name="course_name" class="form-control"
                                            placeholder="Search by Activity Name" value="{{ request('course_name') }}" />
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <a href="{{ route('course.academic-activities.index', ['group' => 'academic-digital-content']) }}"
                                    ...
                                    <tbody>
                                        @foreach ($courses as $course)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $seriesName ?? '-' }}</td>
                                                <td>{{ $className ?? '-' }}</td>
                                                <td>{{ $subjectName ?? 'Digital Activity' }}</td>
                                                <td>
                                                    {{ $course->course_name }}
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title"
                                                                ...
                                                                Assign Activities Courses to School
                                                            </h5>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="assignSchools">
                                Assign Academic Activities Courses to Schools
                            </h5>
