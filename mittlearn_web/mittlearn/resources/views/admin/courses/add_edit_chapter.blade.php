                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-8">
                                    <form method="GET" action="{{ route('course.add.chapter', [$course_id]) }}"
                                        class="row g-2 align-items-center">
                                        <div class="col-md-5">
                                            <input type="text" name="chapter_name" class="form-control"
                                                placeholder="Search by Chapter Name"
                                                value="{{ request('chapter_name') }}" />
                                        </div>
                                        <div class="col-md-4">
                                            <button type="submit" class="btn btn-primary">Search</button>
                                            <a href="{{ route('course.add.chapter', [$course_id]) }}"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="card-title">All Chapters For: &nbsp;{{ $courseName }}</h5>
                                <div class="text-end">
                                    <a href="{{ route('courses.chapter.bulk-upload', request()->route('course_id')) }}"
                                ...
                                <table id="datatable" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        @foreach ($chapters as $chapter)
                                            <tr>
                                                <td>{{ $chapters->firstItem() + $loop->index }}.</td>
                                                <td>
                                                ...
                                                <td>
                                                    <span title="{{ $chapter->chapter_description }}"
                                                        style="cursor: pointer;">
                                                        {{ \Illuminate\Support\Str::limit($chapter->chapter_description, 80) }}
                                                    </span>
                                                </td>


                                                </td>
                                                <livewire:courses-chapter-sort-order :chapter="$chapter" :key="$chapter->id" />

                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        @isPermission('course.edit')
                                                            <a class="btn btn-warning btn-sm me-2"
                                                                href="{{ route('course.chapter.edit', $chapter->id) }}"
                                                                title="Edit">
                                                                <i class="fa fa-pencil"></i>
                                                            </a>
                                                        @endisPermission
                                                        @isPermission('course.delete')
                                                            <a class="btn btn-danger btn-sm me-2" href="javascript:void(0);"
                                                                onclick="confirmDelete('{{ route('course.chapter.delete', $chapter->id) }}')"
                                                                title="Delete">
                    ...
                    <div class="row">
                        ...
                        {{-- <div class="col-sm-6 text-end mt-3">
                                    <button type="button" class="btn btn-success" data-bs-toggle="tooltip"
                                        data-bs-placement="bottom" data-bs-title="Create Folder"><span
                                            data-bs-target="#createFolder" data-bs-toggle="modal">Create New
                                            Folder</span></button>
                                </div> --}}
                    </div>
                    <hr class="form-divider">

                    {{ Form::model($course ?? null, ['url' => route('course.add.chapter.store'), 'id' => 'add-course-form', 'class' => 'row g-3', 'files' => true]) }}
                    {{ Form::hidden('course_id', request()->route('course_id')) }}

                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                            <div class="">
                                {!! Form::label('chapter_title', 'Chapter Title', ['class' => 'form-label required']) !!}
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                            <div class="">
                                {!! Form::label('chapter_description', 'Chapter Description', ['class' => 'form-label required']) !!}
                                {{ Form::textarea('chapter_description', null, [
                                    'class' => 'form-control',
                                    'autocomplete' => 'off',
                                    'required',
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                            <div class="">
                                {!! Form::label('sort_order', 'Chapter Sort Order', ['class' => 'form-label required']) !!}
                                {{ Form::number('sort_order', null, [
                                    'class' => 'form-control',
                                    'autocomplete' => 'off',
                                    'required',
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                            <div class="">
                                ...
                                {{ Form::date('content_creation_date', \Carbon\Carbon::today()->format('Y-m-d'), [
                                    'class' => 'form-control',
                                    'autocomplete' => 'off',
                                    'required',
                                ]) }}
                        ...
                        {{-- <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                                    {!! Form::label('supporting_folder_id', 'Select Additional Document', [
                                        'class' => 'form-label',
                                        'data-bs-toggle' => 'tooltip',
                                        'title' => 'Additional Document Like : Teaching Manuals / Question Bank / Lesson Planner',
                                    ]) !!}
                                    <small data-bs-toggle="tooltip"
                                        title="Additional Document Like : Teaching Manuals / Question Bank / Lesson Planner">(TM/QB/LP)</small>

                                    {!! Form::select('supporting_folder_id', $folder_list, null, [
                        ...
                        @if ($courseCategory == 1)
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                                {!! Form::label('lesson_planner', 'Lesson Plan', ['class' => 'form-label']) !!}
                        ...
                        @else
                            <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                                {!! Form::label('worksheet', 'Worksheets/Practice Sheets', ['class' => 'form-label']) !!}
                                {!! Form::file('worksheet', ['class' => 'form-control']) !!}
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                                {!! Form::label('answer_sheet', 'Answer Sheet', ['class' => 'form-label']) !!}
                                {!! Form::file('answer_sheet', ['class' => 'form-control']) !!}
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                                {!! Form::label('other_pdf', 'Other PDF', ['class' => 'form-label']) !!}
                                <small data-bs-toggle="tooltip" title="Extra PDF">(Extra PDF)</small>
                                {!! Form::file('other_pdf', ['class' => 'form-control']) !!}
                            </div>
                        @endif
                        @php
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="file" name="chapter_file[0]" class="form-control video-input"
                                        data-index="0" @if ($subcategoryId != 37) required @endif />
