    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Course Levels</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card-title">All Course Levels</div>
                            </div>
                            <div class="col-sm-6 text-end mt-3">
                                @isPermission('level.create')
                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @isPermission('level.edit')
                                                    <a class="btn btn-sm btn-warning"
                                                        href="{{ route('level.edit', $item->id) }}"><i
                                                            class="fa fa-pencil"></i></a>
                                                @endisPermission
                                                @isPermission('level.delete')
                                                    <a class="btn btn-danger btn-sm me-2" href="javascript:void(0);"
                                                        onclick="confirmDetailsDelete('{{ route('level.delete', $item->id) }}','Course Level')">
