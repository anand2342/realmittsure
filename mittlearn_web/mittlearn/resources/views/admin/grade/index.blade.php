                                ...
                                <tbody>
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                {{--  @isPermission('grade.edit')  --}}
                                                <a class="btn btn-sm btn-warning"
                                                    href="{{ route('grade.edit', $item->id) }}"><i
                                                        class="fa fa-pencil"></i></a>
                                                {{--  @endisPermission  --}}
                                                {{--  @isPermission('grade.delete')  --}}
                                                <a class="btn btn-danger btn-sm me-2" href="javascript:void(0);"
                                                    onclick="confirmDetailsDelete('{{ route('grade.delete', $item->id) }}','Grade')">
