<div class="col-lg-12">
    <div class="card">
        <div class="card-body row">
            <div class="col-md-9">
                <form method="GET" action="{{ route('erp-data.students.index') }}">
                    <div class="d-flex flex-wrap align-items-center ">
                        ...
                        <div class="col-md-2 me-2 mb-2 mt-4">
                            ...
                            <a href="{{ route('erp-data.students.index') }}" class="btn btn-secondary">Clear</a>
                        </div>
                    </div>
                </form>
            </div>
...
@livewire('erp-edit-student', ['datalist' => $datalist, 'classes' => $classes])
