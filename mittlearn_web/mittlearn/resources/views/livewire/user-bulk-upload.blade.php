<div>
            ...
            <div class="col-md-2 col-sm-12 mt-2">
                ...
                <ul class="dropdown-menu" aria-labelledby="downloadDropdown">
                    @foreach ($roles as $roleKey => $roleValue)
                        <li>
                            <a class="dropdown-item" href="#" onclick="downloadSampleFile('{{ $roleKey }}')">
                                {{ $roleValue }}
                            </a>
                        </li>
                    @endforeach
    ...
    {{-- <script>
        function downloadSampleFile(roleKey) {
            //     const downloadUrl = `{{ route('user.download.sample', ['roleKey' => ':roleKey']) }}`.replace(':roleKey', roleKey);
            const downloadUrl = `/admin/sample-files/${roleKey}-sample-file.xlsx`;
