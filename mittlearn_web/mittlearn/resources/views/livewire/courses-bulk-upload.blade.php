    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 mb-3">
                ...
                <small class="form-text text-muted">(For bulk upload, please select a group and a sub-group.)</small>
                {!! Form::select('group', $categories, null, [
                    'class' => 'form-select',
                    'required',
                    'placeholder' => '--Select Group--',
                    'wire:model' => 'selectedCategory',
                    'wire:change' => 'childCategoriesFetch',
                ]) !!}
            </div>
            <!-- Subgroup Selection -->
            <div class="col-md-6 col-sm-12 mb-3" id="acadmic-category-div">
                {!! Form::label('subgroup', 'Subgroup', ['class' => 'form-label required']) !!}
                {!! Form::select('subgroup', $selectedSubCategory ?: [], null, [
                    'class' => 'form-select',
                    'required',
                    'placeholder' => '--Select Subgroup--',
                    'wire:model' => 'selectedSubGroup',
                ]) !!}
                @if (session()->has('error'))
                    <span class="text-danger d-block mt-1">
                        <small><i class="bi bi-exclamation-octagon me-1"></i>{{ session('error') }}</small>
                    </span>
                @endif
            </div>
        </div>
