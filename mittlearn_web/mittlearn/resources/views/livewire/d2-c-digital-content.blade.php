<div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            {{ Form::open(['url' => route('d2c-content.class.update'), 'id' => 'edit-plan-form', 'class' => 'row g-3', 'enctype' => 'multipart/form-data']) }}
                    ...
                    <table class="table table-striped table-bordered align-middle text-nowrap">
                        ...
                        <thead>
                            <tr>
                                ...
                                {{-- <th width="20%">Category & Additional Courses</th> --}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="multipleSel" wire:ignore>
                                            <select name="course_ids[{{ $key }}][]"
                                                ...
                                                @foreach ($categoryCoursesPerClass[$key] ?? [] as $courseId => $courseName)
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if (!$fileExists)
                                                <button wire:click="generateQrCode('{{ $key }}')"
                                                    ...
                                                    wire:target="generateQrCode('{{ $key }}')" type="button"
                                            ...
                                            @if ($fileExists && isset($data['qr_name']) && isset($data['qr_code_link']))
                                                <div>
                                                    ...
                                                    <div class="input-group mb-2">
                                                        <input type="text" class="form-control"
                                                            id="qrLink{{ $data['qr_code_link'] }}"
                                                            value="{{ $data['qr_code_link'] }}" readonly>
                                                        <button class="btn btn-outline-primary" type="button"
                                                            id="copyButton{{ $data['qr_code_link'] }}"
