        ...
        <div class="row damceCourse">
                        ...
                        <li>
                            <button type="button" class="chapterBtn selected">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="">
                                        <span><img src="{{ asset('frontend/images/clock.svg') }}" alt="" width="12"> 34:45</span>
                                    </div>
                                </div>
                            </button>
                        </li>
            ...
            <div class="col-md-8 ps-md-1 mb-3">
                <div class="cardBox p-0 chapterDetail h-100">
                    <!-- code -->
                    <video style="width: 100%;height:300px;object-fit: cover;" controls controlsList="nodownload" oncontextmenu="return false;">
                    ...
                    <div class="p-3">
                        <div class="d-md-flex flex-wrap justify-content-between mb-3">
                            ...
                            <div class="chapterSlide d-flex align-items-center gap-2 justify-content-end">
                                ...
                                <button type="button" class="prevBtn"><img src="{{ asset('frontend/images/previcon.svg') }}"
                                        width="30"></button>
                                <button type="button" class="nextBtn"><img src="{{ asset('frontend/images/nexticon.svg') }}"
                                        width="30"></button>
                            </div>
                        </div>
                    ...
                    <div class="chapterBtn">
                        <figure class="position-relative">
                            ...
                            <button type="button" class="plybtn" data-bs-toggle="modal"
                                data-bs-target="#coursePreview"><img src="{{ asset('frontend/images/play-btn.svg') }}" alt=""
                                    width="30"></button>
                        </figure>
                        <div class="w-100 p-2">
                ...
                <li>
                    <div class="chapterBtn">
                        <figure class="position-relative">
                            ...
                            <button type="button" class="plybtn"><img src="{{ asset('frontend/images/play-btn.svg') }}" alt=""
                                    width="30"></button>
                        </figure>
                        <div class="w-100 p-2">
                            <div class="d-flex justify-content-between mb-2">
