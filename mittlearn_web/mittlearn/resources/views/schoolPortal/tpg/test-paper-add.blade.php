...
@section('content')
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const offlineDuration = document.querySelector('input[name="duration"]:not(#onlineFields input)');
            const onlineDuration = onlineFields.querySelector('input[name="duration"]');
            ...
            function toggleFields() {
                ...
                if (value === 'online') {
                    ...
                    // Enable online, disable offline
                    onlineDuration.disabled = false;
                    offlineDuration.disabled = true;
                } else {
                    onlineFields.style.display = 'none';

                    // Enable offline, disable online
                    onlineDuration.disabled = true;
                    offlineDuration.disabled = false;
                }
            }
