...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('sp.class.subject', $class_id) }}">Class Subjects</a></li>
            <li class="breadcrumb-item active" aria-current="page">Book Listing</li>
        </ol>
    </nav>
    <div class="cardBox myCourses">
        ...
        <div class="table-responsive tbleDiv ">
            <table class="table ">
                <thead>
                    <tr>
                        <th><span class="classSubject">{{ $className }} - {{ $subjectName }} -</span> Book Name</th>
                        <th>Class</th>
                        <th>Subject</th>
                ...
                <tbody>
                    ...
                    @foreach ($courseListing as $data)
                        ...
                        <tr>
                            ...
                            <td>
                                @php
                                    $subjectInfo = $data->metadataValues->where('field_name', 'subject')->first();
                                @endphp
                                {{ $subjectInfo->subjectInfo->name ?? 'N/A' }}
                            </td>
                            @if (config('COURSES_FILTER_BY_ACCESS_CODE') == 1)
                            ...
                            <td>Academic</td>
                            <td>
                                <a href="{{ route('sp.courses.details', ['id' => $data->id, 'classId' => $class_id, 'subjectId' => $id]) }}"
