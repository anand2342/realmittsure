...
@section('content')
        ...
        <div class="d-flex flex-wrap">
            <div class="leftpanel">
                <div class="helloSection">
                    <div class=" pe-md-5">
                        <h2><b>My</b> Subscription</h2>
                        <p>View and update your active subscriptions.</p>
                    </div>
                ...
                <div class="cardBox">
                    <div class="d-flex justify-content-between align-items-center ">
                        <ul class="nav nav-tabs onlineTabs tbs widthFit m-0">
                            <li class="nav-item">
                        ...
                        <lottie-player src="{{ asset('mittbunny/images/turtle-course.json') }}" class="turtleNone"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="planDetailsTb">
                                ...
                                <div class="row">
                                    <div class="col-md-7 mb-3">
                                        <div class="planContent">
                                            <div class="planName">
                                                <figure><img src="{{ asset('mittbunny/images/mittlearnround-logo.svg') }}"
                                                        alt="" width="40">
                                                </figure>
                                                <div class="">
                                                    ...
                                                    @if (isset($data['plan']->end_date))
                                                        <p>Next billing on
                                                            {{ \Carbon\Carbon::parse($data['plan']->end_date ?? '')->format('jS F, Y') }}
                                                        </p>
                                                    @endif
                            ...
                            <div>
                                @if (!empty($data['plan']))
                                    ...
                                    <div class="accessDetails d-md-flex align-items-center mt-3">
                                        <ul class="accessUl">
                                            @if (!empty($data['plan']))
                                        ...
                                        <lottie-player src="{{ asset('mittbunny/images/octopus.json') }}"
                                    ...
                                    <body>
                                        @if (!empty($data['plan']))
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $data['plan']->payer_payment_method ?? 'N/a' }}</td>
                                            </tr>
                                        @else
                                            <tr>
                        ...
                        <div class="tab-pane fade" id="transactionTb">
                            ...
                            <div class="table-responsive tbleDiv tbleTrans mb-2">
                                <table class="table">
                                    {{-- <tbody>
                                        <tr>
                                            <td class="fw-semibold">03 March 2024</td>
                                            <td class="text-primary">Basic Plan</td>
                                            <td><b> 8700.00</b></td>
                                            <td><span class="paidBadge">Paid</span></td>
                                        </tr>
                                    </tbody> --}}
                                    <tbody>
                                        @if (isset($data['transactionLogsLatest']) && !empty($data['transactionLogsLatest']))
                                            <tr>
                                                ...
                                                <td>
                                                    @if (isset($data['transactionLogsLatest']) && $data['transactionLogsLatest']->payment_state === 'Completed')
                            ...
                            <div class="table-responsive tbleDiv tbleTrans">
                                <table class="table">
                                    <tbody>
                                        @if (isset($data['transactionLogs']) && count($data['transactionLogs']) > 0)
                                            @foreach ($data['transactionLogs'] as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if ($item->payment_state === 'Completed')
                                                            <span class="paidBadge">Paid</span>
                                                        @else
                                                            <span class="failedBadge">Failed</span>
                                                        @endif
    ...
    <div class="modal fade text-center otpModal" id="otpModal">
                ...
                <div class="modal-body">
                    <div class="loginMain p-0">
                        <div class="pb-2 text-center">
                            <img src="{{ asset('mittbunny/images/mittlearn-logo.svg') }}" alt="" width="140">
                        </div>
                        <lottie-player src="images/orange-cat-expression-faded.json" background="transparent"
                            speed="1" style="width: 60px; height: 60px;margin-left: auto;" loop
                            autoplay></lottie-player>
                        <h3 class="text-center pt-4">OTP Verification</h3>
                        <p class=" mb-4">Enter OTP which is send to your mobile number or Email Id</p>
                        <form action="{{ route('mittbunny.upgrade.subscription') }}" method="POST">
                            @csrf
                            <div class="otpMain">
                            ...
                            <span class="timing mt-2">Resend OTP in <b id="countdown">30</b> seconds</span>
                            <strong class="signupTxt pb-0">Didn't get a code? <a href="#" id="resendOtp"><u>Click
                                        to Resend</u></a></strong>

                            <div class="text-center my-1 mt-4 pt-2">
                                <button type="button" id="verifyOtpBtn" class="btn btn-success fs-7 rounded-2 w-75">
                                    Submit
                                </button>
                            </div>
                        </form>
