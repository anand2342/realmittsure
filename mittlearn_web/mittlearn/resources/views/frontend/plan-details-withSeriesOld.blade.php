            ...
            <div class="bannerTxt">
                ...
                <div class="subscriptionTab">
                    <ul>
                        ...
                        <li><button type="button" class="tbButton @if ($activeTab == 'nonacademic') active @endif"
    ...
    <div class="container">
        ...
        <div class="dropdownFilter" id="academicGroupFilter">
            <div class="row">
                ...
                <div class="col-6 col-md-3 mb-3">
                    <div class="form-group" id="book-series-group">
                        {!! Form::label('book_series_id', 'Select BookSeries', ['class' => 'form-label required']) !!}
                        {!! Form::select('book_series_id', [], null, [
                            'class' => 'form-select',
        ...
        <div class="dropdownFilter" id="non-academicGroupFilter">
            <div class="row">
                <div class="col-6 col-md-3 mb-3" id="subcategory-group">
        ...
        $(document).ready(function() {
            ...
            if (firstButton.length > 0) {
                ...
                if (defaultCategoryId === 1) {
                    ...
                    var bookSeriesId = $('#book-series-select').val();
                    var classId = $('#class-select').val();

                    if (boardId && mediumId && bookSeriesId && classId) {
                        loadCourses(1);
                    }
            ...
            $('#board-select, #medium-select, #book-series-select, #class-select').change(function() {
                if (defaultCategoryId === 1) {
                    loadCourses(1);
                }
            });
