    ...
    <header class="mainHeader">
        <nav class="navbar navbar-expand-md">
            <div class="container-fluid">
                <a class="navbar-brand p-0" href="{{ route('/') }}"><img
                        src="{{ asset('frontend/images/mittlearn-logo.svg') }}" width="150"></a>
                ...
                <div class=" navbar-collapse" id="navbarContent">
                    <ul class="navbar-nav mx-auto">
                        <li class="nav-item">
                            <a class="nav-link {{ $isActiveIndex }}" aria-current="page"
                                href="{{ route('/') }}">Home</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $isActiveAboutUs }}" href="{{ route('about-us') }}">About Us</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $isActiveBlog }}" href="{{ route('blogs') }}">Blog</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $isActiveContactUs }}" href="{{ route('contact-us') }}">Contact
                                Us</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ $isActiveOurOfferings }}" href="{{ route('our-offerings') }}">Our
                                Offerings</a>
                        </li>
                    </ul>
                    <div class="d-flex gap-2 p-3 justify-content-center p-md-0 btnHeader">
                        ...
                        @if (Auth::check())
                            ...
                            @endphp
                            <a href="{{ $dashboardRoute }}" class="btn btn-primary rounded-2">Dashboard</a>
                            <!-- Cart btn -->
                            <form action="{{ route('cart') }}" method="GET" class="cartForm">
                                <input type="hidden" name="user_id" value="{{ Auth::id() }}">
                                <input type="hidden" id="guestUserId" name="session_id" value="">
                                <button class="btn btn-primary rounded-2 " type="submit"><img
                                        src="{{ asset('frontend/images/cart-icon-filled.svg') }}" alt="Cart Icon"
                                        class="cart-icon" width="15"> Cart</button>
                            </form>
                        @else
                            <a href="{{ route('register') }}"
                                class="btn btn-primary rounded-2 registerBtn">Register</a>
                            <a href="{{ route('login') }}" class="btn btn-success rounded-2">Login</a>
                            <form action="{{ route('cart') }}" method="GET" class="cartForm">
                                <input type="hidden" name="user_id"
                                    value="{{ auth()->check() ? base64_encode(auth()->user()->id) : '' }}">
                                <input type="hidden" id="guestUserId" name="session_id" value="">
                                <button class="btn btn-primary rounded-2" type="submit"><img
                                        src="{{ asset('frontend/images/cart-icon-filled.svg') }}" alt="Cart Icon"
                                        class="cart-icon" width="15"> Cart</button>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4 pe-md-5 mb-4">
                    <figure>
                        <img src="{{ asset('frontend/images/mittlearn-logo.svg') }}" alt="" width="200">
                    </figure>
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            ...
                            <div class="download mt-5"><a href="{{ route('download.app') }}"
                            ...
                            <div class="footLink">
                                ...
                                <ul>
                                    <li class="d-flex gap-2">
                                        {{-- <img src="{{ asset('frontend/images/location-icon.svg') }}" width="15"> --}}
                                        <i class="fa-solid fa-location-dot"></i>
                                        {{ $links[' address'] }}
                                    </li>
                                    <li class="d-flex gap-2">
                                        {{-- <img src="{{ asset('frontend/images/call-icon.svg') }}" width="15"> --}}
                                        <i class="fa-solid fa-phone"></i>
                                        <a href="tel:+1800 8917070">{{ $links['contact_number'] }}</a>
                                    </li>
                                    <li class="d-flex gap-2 emailTxt">
                                        {{-- <img src="{{ asset('frontend/images/mail-icon.svg') }}" width="15"> --}}
        ...
        <div class="container-fluid mt-3">
            <div class="row copyrightTxt">
                <div class="col-md-6 pb-3">
                    <p class="mb-0">Copyright {{ '@' . date('Y') }} Mittlearn. All Rights Reserved.</p>
                </div>
                <div class="col-md-6 pb-3">
                    <ul class="d-flex flex-wrap gap-2 justify-content-end">
                        <li><a target="_blank" href={{ $links['facebook'] }}><img
                                    src="{{ asset('frontend/images/facebook-front.svg') }}" width="10"></a>
                        </li>
                        <li><a target="_blank" href={{ $links['instagram'] }}><img
                                    src="{{ asset('frontend/images/instagram-front.svg') }}" width="20"></a></li>
                        <li><a target="_blank" href={{ $links['twitter'] }}><img
                                    src="{{ asset('frontend/images/twitter-front.svg') }}" width="20"></a>
                        </li>
                        <li><a target="_blank" href={{ $links['linkedin'] }}><img
                                    src="{{ asset('frontend/images/linkedin-front.svg') }}" width="20"></a></li>
                        <li><a target="_blank" href={{ $links['you_tube'] }}><img
                                    src="{{ asset('frontend/images/youtube-front.svg') }}" width="25"></a>
                        </li>
                    </ul>
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function updateSessionTab(tab) {
                fetch("{{ route('store.browser.session') }}", {
                    method: "POST",
                    headers: {
