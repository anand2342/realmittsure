        ...
        <div class="loginMain">
            ...
            <div class="loginSec registerPage">
                ...
                <div class="loginFormBox">
                    ...
                    @endif
                    <form method="POST" action="{{ route('demo.access.code.submit') }}" id="register-password-form">
                        @csrf
                        ...
                        @if (isset($matchedMedium))
                            <input type="hidden" placeholder="" name="medium_id" value="{{ $matchedMedium }}">
                        @endif
                        {{-- <input type="hidden" placeholder="" name="class_id" value="{{ $matchedClass->id }}">
                        <input type="hidden" placeholder="" name="category_id" value="{{ $matchedCategory->id }}">
                        @if (isset($matchedMedium))
                            <input type="hidden" placeholder="" name="medium_id" value="{{ $matchedMedium->id }}">
                        @endif --}}
                        {{-- <input type="hidden" name="last_segment" value="{{ basename(request()->path()) }}"> --}}
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="position-relative">
                                        <input class="form-control w-100 pe-5 @error('mobile') is-invalid @enderror"
                                            ...
                                            value="{{ $data->mobile_no ?? old('mobile') }}" autocomplete="mobile"
                                            autofocus>
                                        @error('mobile')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                            ...
                            <div class="col-md-12 px-md-2">
                                <div class="form-group mb-4">
                                    ...
                                    <input class="form-control w-100 @error('access_code') is-invalid @enderror"
                                        type="text" placeholder="" name="access_code" id="access_code"
