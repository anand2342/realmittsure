                ...
                <div class="loginFormBox">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="registerTab">
                            ...
                            <form method="POST" action="{{ route('d2c.qr.register.store') }}">
                                @csrf

                                {{-- QR Context --}}
                                <input type="hidden" name="class_id" value="{{ $matchedClass->id }}">
                                <input type="hidden" name="category_id" value="{{ $matchedCategory->id }}">
                                @if (isset($matchedMedium))
                                    <input type="hidden" name="medium_id" value="{{ $matchedMedium->id }}">
                                @endif
                                {{-- SN hidden field --}}
                                <input type="hidden" name="sn" value="{{ $sn ?? 1 }}">
