            ...
            <td align="left" valign="top" width="600px" style="max-width:100%;" cell-spacing="0" cell-padding="0">
                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td>
                            <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                style="padding:5px 15px; background: #fff;">
                                <tr>
                                    <td align="left" valign="middle" style="padding:5px 0px;  "></td>
                                    <td align="center" valign="middle" style="padding:5px 0px; "><a
                                            href="https://mittlearn.com/" target="_blank"
                                            style="color:#000040; font-size:18px; text-decoration:none; color:#fff; font-weight:bold; text-transform:uppercase;"><img
                                                src="https://mittlearn.com/frontend/images/mittlearn-logo.svg"
                                                alt="" width="200" /></a></td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ddd"
                                ...
                                <tr>
                                    <td valign="top" align="left"style="padding:10px 20px; text-align:center;"><span
                                            ...
                                            <?php echo date('Y'); ?>. All Rights Reserved.</span></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
