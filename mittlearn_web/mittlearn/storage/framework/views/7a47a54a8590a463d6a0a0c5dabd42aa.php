<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($paginator->hasPages()): ?>
    <div class="customPagination mt-4">
        <ul class="pagination">
            <li class="page-item <?php echo e($paginator->onFirstPage() ? 'disabled' : ''); ?> previous-item">
            ...
            <li class="page-item <?php echo e($paginator->hasMorePages() ? '' : 'disabled'); ?> next-item">
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\Users\Mittsure\Desktop\mittlearn_web1\mittlearn_web\mittlearn\resources\views/vendor/pagination/bootstrap-4.blade.php ENDPATH**/ ?>