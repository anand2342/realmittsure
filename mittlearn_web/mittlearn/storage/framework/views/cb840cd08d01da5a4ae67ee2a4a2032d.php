<?php $__env->startSection('content'); ?>
    <div class="shoppingMain">
        <div class="shoppingCart">
            <div class="container">
                ...
                <div class="cartHeading">
                    <a href="<?php echo e(route('/')); ?>" class="">
                        <img src="<?php echo e(asset('frontend/images/cart-arrow.svg')); ?>" alt="" width="20">
        ...
        <div class="container cartContainer">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($plan_packs['free_academic_courses']) || !empty($plan_packs['free_nonacademic_courses'])): ?>
                <div style="background: #FFD28D;"
                    ...
                    <p class="w-100 mb-0 text-primary">
                        ...
                        <?php if(!empty($plan_packs['free_academic_courses'])): ?>
                            <b><?php echo e($plan_packs['free_academic_courses']); ?> free</b> academic
                            course<?php echo e($plan_packs['free_academic_courses'] > 1 ? 's' : ''); ?>

                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(!empty($plan_packs['free_academic_courses']) && !empty($plan_packs['free_nonacademic_courses'])): ?>
                            and
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($plan_packs['free_nonacademic_courses'])): ?>
                            <b><?php echo e($plan_packs['free_nonacademic_courses']); ?> free</b> talent & skills
                            course<?php echo e($plan_packs['free_nonacademic_courses'] > 1 ? 's' : ''); ?>

                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ; add it for free to your cart.
                    </p>
                    <div class="text-center">
                        <a class="accessFreeCoursesBtn text-nowrap" data-plan-id="<?php echo e(base64_encode($plan->id)); ?>"
            ...
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($itemsCount) && $itemsCount > 0): ?>

                <div class="row">
                    <div class="col-xl-8 col-lg-12">
                        <div class="shoppingTable">
                            <div class="tblheadCart mb-2">
                                <h2><b><?php echo e($itemsCount); ?> items</b> in your bag</h2>
                                <span>Subtotal (<?php echo e($itemsCount); ?> items):
                                    <b>₹<?php echo e(number_format($totalAmount, 2)); ?></b></span>
                            </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center myCourseLft">
                                                        <figure>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bnrImage): ?>
                                                                <img src="<?php echo e(Storage::url($bnrImage)); ?>"
                                                                    alt="course-thumbnail-image">
                                                            <?php elseif($bkCoverImage): ?>
                                                                <img src="<?php echo e(Storage::url($bkCoverImage)); ?>"
                                                                    alt="course-thumbnail-image">
                                                            <?php elseif($thumImage): ?>
                                                                <img src="<?php echo e(Storage::url($thumImage)); ?>"
                                                                    alt="course-thumbnail-image">
                                                            <?php else: ?>
                                                        ...
                                                        <div class="coursesName">
                                                            <h3><?php echo e(optional($item->getCourses)->course_name ?? ''); ?></h3>
                                                            <p>by Mittlearn</p>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(optional(optional($item->getCourses)->getCategoryCourse)->name): ?>
                                                                <span>Category:
                                                                    <?php echo e(optional(optional($item->getCourses)->getCategoryCourse)->name); ?></span>
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                ...
                                                <td class="fullPriceCart">
                                                    <?php echo e($item->full_price == 0 ? 'FREE' : '₹' . number_format($item->full_price ?? 0, 2)); ?>

                                                </td>
                                                
                                                <td><?php echo e($item->price == 0 ? 'FREE' : '₹' . number_format($item->price, 2)); ?>
                                                ...
                                                <td class="text-center">
                                                    <button type="button"
                                                        ...
                                                        <img src="<?php echo e(asset('frontend/images/trash.svg')); ?>"
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($plan_packs['status']) && $plan_packs['status'] === 'success'): ?>
                            <div class="discountBx">
                                ...
                                <span><b>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($discountType === 'flat'): ?>
                                            <?php echo e($discountSymbol); ?><?php echo e($discountValue); ?> <!-- ₹ before the value for flat -->
                                        <?php elseif($discountType === 'percent'): ?>
                                            <?php echo e($discountValue); ?><?php echo e($discountSymbol); ?>
                                ...
                                <p class="w-100">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($remainingCourses > 0): ?>
                                        To avail this offer, add <?php echo e($remainingCourses); ?> more items.
                                    <?php else: ?>
                        ...
                        <div class="cartTotal">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($isFreeTrial) && $isFreeTrial): ?>
                                            ₹<?php echo e(number_format($totalAmount ?? 0, 2)); ?>

                                        <?php else: ?>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($plan_packs['current_discount_type']) && $plan_packs['current_discount_type'] === 'flat'): ?>
                                                ₹<?php echo e(number_format($plan_packs['current_discount'] ?? 0, 2)); ?>

                                            <?php elseif(isset($plan_packs['current_discount_type']) && $plan_packs['current_discount_type'] === 'percent'): ?>
                                                ₹<?php echo e(number_format((($totalAmount ?? 0) * ($plan_packs['current_discount'] ?? 0)) / 100, 2)); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold" id="grandTotalAmount">
                                        ...
                                        $grandTotal = $isFreeTrial ? 0 : ($totalAmount ?? 0) - ($discount ?? 0); ?>
                                        ₹<?php echo e($isFreeTrial ? '0.00 ' . ' (free-trial)' : number_format($grandTotal, 2)); ?>
                            ...
                            <form action="<?php echo e(route('cart.checkout.process')); ?>" method="POST">
                                ...
                                <input type="hidden" name="total_amount"
                                    value="<?php echo e($isFreeTrial ? '0.00' : number_format($totalAmount, 2)); ?>">
                                <input type="hidden" name="total_discount"
                                    value="<?php echo e($isFreeTrial ? '0.00' : number_format($discount, 2)); ?>">
                                <input type="hidden" name="grand_total"
                                    value="<?php echo e($isFreeTrial ? '0.00' : number_format($grandTotal, 2)); ?>">

                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <input type="hidden" name="cart_items[]" value="<?php echo e($item->course_id); ?>">
                                    <input type="hidden" name="plan_id" value="<?php echo e($item->item_id); ?>">
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <?php else: ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isFreeTrial): ?>
                                            <form method="POST" action="<?php echo e(route('cart.checkout.process')); ?>">
                                                <?php echo csrf_field(); ?>
                                                <input type="hidden" name="is_free_trial" value="1">
            ...
            <?php else: ?>
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <a href="<?php echo e(route('/')); ?>" class="btn btn-primary">Continue Browse</a>
                    </div>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.accessFreeCoursesBtn').each(function() {
                ...
                const updatedUrl =
                    `<?php echo e(route('plan.detail', '')); ?>/${planId}?session_id=${session_id}&type=${type}`;
    ...
    <script>
        document.getElementById('rzp-button1').onclick = function(e) {
            ...
            let cartPlanId = <?php echo e($cartItems[0]->item_id ?? 'null'); ?>;

            // Update Razorpay options dynamically
            var options = {
                "key": "<?php echo e(config('services.razorpay.key_id')); ?>", // Razorpay Key ID
                ...
                "handler": function(response) {
                    ...
                    $.ajax({
                        url: "<?php echo e(route('cart.checkout.process')); ?>",
                        type: "POST",
                        data: {
                            ...
                            plan_id: cartPlanId,
                            cart_items: <?php echo json_encode(($cartItems ?? collect([]))->pluck('course_id')); ?>,

                        },
                        success: function(data) {
                            // Redirect to home page after successful payment
                            window.location.href = "<?php echo e(route('up.dashboard')); ?>";
                        },
                ...
                "prefill": {
                    ...
                    "contact": "<?php echo e(Auth::user()->mobile_no ?? ''); ?>"
                },
                "theme": {
                    "color": "#00BE55"
                }
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mittsure\Desktop\mittlearn_web1\mittlearn_web\mittlearn\resources\views/frontend/cart.blade.php ENDPATH**/ ?>