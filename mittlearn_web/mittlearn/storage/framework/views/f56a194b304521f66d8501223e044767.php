<div>
    ...
    <div class="mb-3">
        <div class="row align-items-center">
            ...
            <div class="col-md-2">
                <a href="<?php echo e(asset($roleName === 'school_student' ? '/admin/sample-files/school_student-sample-file.xlsx' : '/admin/sample-files/school_teacher-sample-file.xlsx')); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <button type="button" class="btn btn-sm btn-success rounded-1 px-3 bluckBtn"
                        ...
                        <?php if(!$file): ?> disabled <?php endif; ?>>
                        Upload
                    </button>
...
<?php /**PATH C:\Users\Mittsure\Desktop\mittlearn_web1\mittlearn_web\mittlearn\resources\views/livewire/school-bulk-upload.blade.php ENDPATH**/ ?>