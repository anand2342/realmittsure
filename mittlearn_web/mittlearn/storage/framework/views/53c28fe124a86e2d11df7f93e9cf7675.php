                    ...
                    <div class="card-body">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <a href="<?php echo e(route('user-manual.add')); ?>" class="btn btn-success">
                                    Add New
                                </a>
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($data->isNotEmpty()): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge <?php echo e($item->is_active ? 'text-success' : 'text-danger'); ?>">
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-warning"
                                                        href="<?php echo e(route('user-manual.edit', $item->id)); ?>">
                                                        <i class="fa fa-pencil"></i>
                                                    </a>
                                                    <a class="btn btn-danger btn-sm me-2" href="javascript:void(0);"
                                                        onclick="confirmDelete('<?php echo e(route('user-manual.delete', $item->id)); ?>')">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mittsure\Desktop\mittlearn_web1\mittlearn_web\mittlearn\resources\views/admin/userManual/index.blade.php ENDPATH**/ ?>