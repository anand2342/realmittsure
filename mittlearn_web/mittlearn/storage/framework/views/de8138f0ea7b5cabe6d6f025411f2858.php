                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php echo e(Form::model($chapter ?? null, [
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                                    <?php echo Form::label('chapter_title', 'Chapter Title', ['class' => 'form-label']); ?>

                                    <?php echo e(Form::text('chapter_title', $chapter->chapter_name ?? ' ', [
                                        'class' => 'form-control',
                                        'autocomplete' => 'off',
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                                    <?php echo Form::label('chapter_description', 'Chapter Description', ['class' => 'form-label']); ?>

                                    <?php echo e(Form::text('chapter_description', $chapter->chapter_description ?? ' ', [
                                        'class' => 'form-control',
                                        'autocomplete' => 'off',
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                                    <div class="">
                                        ...
                                        <?php echo e(Form::text('topic_covered', $chapter->topic_covered ?? ' ', [
                                            'class' => 'form-control',
                                            'autocomplete' => 'off',
                                            'required',
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                                    <?php echo Form::label('sort_order', 'Chapter Sort Order', ['class' => 'form-label']); ?>

                                    <?php echo e(Form::number('sort_order', $chapter->sort_order ?? ' ', [
                                        'class' => 'form-control',
                                        'autocomplete' => 'off',
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                                    <div class="">
                                        ...
                                        <?php echo e(Form::date('content_creation_date', $chapter->content_creation_date ?? ' ', [
                                            'class' => 'form-control',
                                            'autocomplete' => 'off',
                                            'required',
                                        ])); ?>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 input-div">
                                    <?php echo Form::label('lesson_planner', 'Lesson Planner', ['class' => 'form-label']); ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($chapter_content_extra && count($chapter_content_extra)): ?>
                                    <div class="col-md-12 col-sm-12 col-xs-12 input-div mt-2">
                                        <label class="form-label">Uploaded TM/QB/LP</label>
                                        <hr class="form-divider">
                                        <div class="row">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $chapter_content_extra; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-3 col-sm-3 col-4 mb-3 position-relative class-item">
                                                    <div class="card h-100 p-3">
                                                        <a class="h-100 d-block text-center filesView"
                                                            href="<?php echo e(Storage::url('uploads/course_chapter_files/' . $file->attachment_file)); ?>"
                                                            target="_blank">
                                                            
                                                            <i class="bi bi-filetype-<?php echo e($file->file_extension); ?> fs-1"
                                                                style="color:#30C768;"></i>
                                                            <p class="text-center mt-2 mb-0" style="font-size: 13px">
                                                                <?php echo e($file->attachment_file); ?></p>
                                                        </a>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(
                                                            ...
                                                            <p class="text-center mt-2" style="font-size: 13px">Duration:
                                                                <?php echo e($file->video_duration ? gmdate('H:i:s', $file->video_duration) : 'N/A'); ?>

                                                            </p>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <button type="button"
                                                            class="btn btn-danger btn-sm position-absolute top-0 end-0"
                                                            onclick="confirmDelete('<?php echo e(route('course.chapter.file.delete', $file->id)); ?>')">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activity_worksheet_content && count($activity_worksheet_content)): ?>
                                    <div class="col-12 mt-4">
                                        <label class="form-label fw-semibold mb-2">Uploaded Activity Content</label>
                                        <hr class="form-divider mb-3">

                                        <div class="row g-3">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $activity_worksheet_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="col-md-3 col-sm-4 col-6">
                                                    <div class="card border-0 shadow-sm position-relative h-100">
                                                        <div class="card-body text-center px-2 py-3">
                                                            ...
                                                            <a href="<?php echo e($fullUrl); ?>" target="_blank"
                                                                ...
                                                                <p class="text-center mt-2 mb-0 small">
                                                                    <?php echo e($file->file_name ?: $file->original_name); ?>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12 input-div mt-2">
                                    ...
                                    <hr class="form-divider">
                                    <div class="row">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $chapter_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-3 col-sm-3 col-4 mb-3 position-relative class-item">
                                                <div class="card h-100 p-3">
                                                    ...
                                                    <a class="h-100 d-block text-center filesView"
                                                        ...
                                                        <i class="bi <?php echo e(in_array($extension, $knownFileIcons) ? 'bi-filetype-' . $extension : 'bi-file-play'); ?> fs-1"
                                                            style="color:#30C768;"></i>
                                                        <p class="text-center mt-2 mb-0" style="font-size: 13px">
                                                            <?php echo e($file->file_name ? $file->file_name : $file->original_name); ?>
...
[$__name, $__params] = $__split('chapter-file-sort-order-editor', ['file' => $file]);

$key = $file->id;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1118389045-0', $file->id);
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mittsure\Desktop\mittlearn_web1\mittlearn_web\mittlearn\resources\views/admin/courses/edit_chapter.blade.php ENDPATH**/ ?>