...
<?php $__env->startSection('content'); ?>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('crm_removed') == '1'): ?>
                ...
                <div class="card">
                    <div class="card-body p-3">
                        <form method="GET" action="<?php echo e(route('school.list')); ?>">
                            <div class="row">
                                ...
                                <div class="col mb-3">
                                    <input type="text" class="form-control" placeholder="Search by Unique Id"
                                        name="unique_id" value="<?php echo e(request('unique_id')); ?>">
                                </div>
                                <div class="col mb-3">
                                    <select name="state_id" id="state-select" class="form-control">
                                        <option value="">Search by State</option>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($id); ?>"
                                                <?php echo e(request('state_id') == $id ? 'selected' : ''); ?>>
                                                <?php echo e($name); ?>
                                ...
                                <div class="col mb-3">
                                    <select name="district_id" id="district-select" class="form-control">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($id); ?>"
                                                <?php echo e(request('district_id') == $id ? 'selected' : ''); ?>>
                                                <?php echo e($name); ?>
                                ...
                                <div class="col mb-3">
                                    ...
                                    <a href="<?php echo e(route('school.list')); ?>" class="btn btn-secondary">Clear</a>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-success btn-sm ms-2 text-nowrap" href="<?php echo e(route('all-school-export')); ?>">
                        ...
                        <ul class="nav nav-tabs nav-tabs-bordered" id="schoolTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link <?php echo e($activeTab == 'PartnerSchools' ? 'active' : ''); ?>"
                                    id="partner-tab" data-bs-toggle="tab" data-bs-target="#partner-schools" type="button"
                                    role="tab" aria-controls="partner-schools"
                                    aria-selected="<?php echo e($activeTab == 'PartnerSchools' ? 'true' : 'false'); ?>">
                                    Partner Schools
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link <?php echo e($activeTab == 'NonPartnerSchools' ? 'active' : ''); ?>"
                                    ...
                                    aria-selected="<?php echo e($activeTab == 'NonPartnerSchools' ? 'true' : 'false'); ?>">
                                    Non-Partner Schools
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link <?php echo e($activeTab == 'CrmSchools' ? 'active' : ''); ?>" id="crm-tab"
                                    data-bs-toggle="tab" data-bs-target="#crm-schools" type="button" role="tab"
                                    aria-controls="crm-schools"
                                    aria-selected="<?php echo e($activeTab == 'CrmSchools' ? 'true' : 'false'); ?>">
                                    Schools From CRM
                                </button>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content pt-2" id="schoolTabsContent">
                            <!-- Partner Schools Tab -->
                            <div class="tab-pane fade <?php echo e($activeTab == 'PartnerSchools' ? 'show active' : ''); ?>"
                                ...
                                <div class="table-responsive tbleDiv">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($partnerSchools) && $partnerSchools->count() > 0): ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $partnerSchools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($partnerSchools->currentPage() * $partnerSchools->perPage() - $partnerSchools->perPage() + $loop->iteration . '.'); ?>

                                                        </td>
                                                        <td><?php echo e($item->name ?? ''); ?></td>
                                                        <td><?php echo e($item->unique_id ?? ''); ?></td>
                                                        <td><?php echo e($item->userSchool->name ?? 'N/A'); ?></td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-primary btn-sm me-2"
                                                                href="<?php echo e(route('school.users', ['school_id' => $item->id])); ?>">
                                                                Users
                                                            </a>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('isPermission', 'online.class.logs')): ?>
                                                                <a class="btn btn-primary btn-sm me-2"
                                                                    href="<?php echo e(route('online.class.logs', ['school_id' => $item->id])); ?>">
                                                                    Online Classes</a>
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if (\Illuminate\Support\Facades\Blade::check('isPermission', 'folder.index')): ?>
                                                                <a class="btn btn-primary btn-sm me-2"
                                                                    href="<?php echo e(route('folder.index', ['user_id' => $item->user_id])); ?>">
                                                                    Uploaded Content
                                                                </a>
                                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->user): ?>
                                                                <a class="btn btn-sm statusBtn <?php echo e($item->user->status == 1 ? 'btn-success' : 'btn-danger'); ?>"
                                                                    onclick="confirmStatus('<?php echo e(route('user.active.inactive', $item->user->id)); ?>')">
                                                                    <?php echo e($item->user->status == 1 ? 'Active' : 'Inactive'); ?>
                                ...
                                <div class="d-flex justify-content-right text-right">
                                    <?php echo $partnerSchools->appends(array_merge(request()->query(), ['active_tab' => 'PartnerSchools']))->links('pagination::bootstrap-4'); ?>

                                </div>
                            </div>

                            <!-- Non-Partner Schools Tab -->
                            <div class="tab-pane fade <?php echo e($activeTab == 'NonPartnerSchools' ? 'show active' : ''); ?>"
                                ...
                                <div class="table-responsive tbleDiv">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($nonPartnerSchools) && $nonPartnerSchools->count() > 0): ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $nonPartnerSchools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e($nonPartnerSchools->currentPage() * $nonPartnerSchools->perPage() - $nonPartnerSchools->perPage() + $loop->iteration . '.'); ?>
                                ...
                                <div class="d-flex justify-content-right text-right">
                                    <?php echo $nonPartnerSchools->appends(array_merge(request()->query(), ['active_tab' => 'NonPartnerSchools']))->links('pagination::bootstrap-4'); ?>
                                            ...
                                            <tr>
                                                ...
                                                <th>Action
                                                    <a class="btn btn-success btn-sm ms-2 text-nowrap"
                                                        href="<?php echo e(route('crm.sms.logs')); ?>">
                                                        CRM SMS Logs </a>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($crmSchools) && $crmSchools->count() > 0): ?>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $crmSchools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <?php echo e($crmSchools->currentPage() * $crmSchools->perPage() - $crmSchools->perPage() + $loop->iteration . '.'); ?>
                                                        ...
                                                        <td>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($assignedSeries->isNotEmpty()): ?>
                                                                <div style="display: flex; flex-wrap: wrap; gap: 4px;">
                                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $assignedSeries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $seriesName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php
                                                                            $chip =
                                                                                $chipColors[
                                                                        ...
                                                                        ?>
                                                                        <span
                                                                            style="display: inline-block;padding: 2px 10px;border-radius: 999px;border: 1px solid <?php echo e($chip['border']); ?>;background: <?php echo e($chip['bg']); ?>;
                                                                            color: <?php echo e($chip['text']); ?>;font-size: 12px;font-weight: 500;white-space: nowrap;">
                                                                            <?php echo e($seriesName); ?>
                                                        ...
                                                        <td>
                                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(
                                                                ...
                                                                <button class="btn btn-sm btn-success me-1"
                                                                    onclick="confirmVerifySchool('<?php echo e(route('crm.school.verify', $item->id)); ?>','<?php echo e(addslashes($item->name)); ?>')">
                                                                    Activate
                                                                </button>
                                                            <?php else: ?>
                                                                ...
                                                                <button class="btn btn-sm btn-warning"
                                                                    onclick="confirmSmsToRM('<?php echo e(route('crm.school.sms.rm', $item->id)); ?>','<?php echo e(addslashes($item->name)); ?>' )"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#state-select').on('change', function() {
                ...
                if (stateId) {
                    var url = "<?php echo e(route('school.getCities', ':state')); ?>".replace(':state', stateId);
                    $.ajax({
                        url: url,
                        type: 'GET',
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mittsure\Desktop\mittlearn_web1\mittlearn_web\mittlearn\resources\views/admin/schoolManagement/school-list.blade.php ENDPATH**/ ?>