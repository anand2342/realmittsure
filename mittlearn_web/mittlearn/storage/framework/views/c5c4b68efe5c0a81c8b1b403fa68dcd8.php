                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr wire:key="row-<?php echo e($index); ?>">
                        ...
                        <td>
                            ...
                            <?php echo Form::select("rows[$index][group_id]", $categories, $row['group_id'], [
                                'class' => 'form-control',
                        ...
                        <td>
                            ...
                            <?php echo Form::text("rows[$index][group_academic_title]", $row['group_academic_title'] ?? null, [
                                'class' => 'form-control',
                        ...
                        <td>
                            <?php echo Form::file("rows[$index][group_academic_image]", [
                                'class' => 'form-control',
                                'wire:model.defer' => "rows[$index].group_academic_image",
                            ]); ?>


                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($row['group_academic_image']) && is_string($row['group_academic_image'])): ?>
                                <div class="mt-2">
                                    <img src="<?php echo e(Storage::url('uploads/website-pages/academic/' . $row['group_academic_image'])); ?>"
...
<?php /**PATH C:\Users\Mittsure\Desktop\mittlearn_web1\mittlearn_web\mittlearn\resources\views/livewire/home-page-academic-group.blade.php ENDPATH**/ ?>